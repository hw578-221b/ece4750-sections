...
class IntMulScycleV3_noparam( Component ):
  ...
  def __init__( s, *args, **kwargs ):
    ...
    s._ffi_inst = s.ffi.dlopen('./libIntMulScycleV3_noparam_v.so', s.ffi.RTLD_NODELETE | s.ffi.RTLD_NOW)
  ...
  def finalize( s ):
    ...
    s._ffi_inst.VIntMulScycleV3_noparam_destroy_model( s._ffi_m )
  ...
  def construct( s, *args, **kwargs ):
    ...
    s._ffi_m = s._ffi_inst.VIntMulScycleV3_noparam_create_model( ffi_vl_vcd_file )
    ...
    _ffi_m = s._ffi_m
    _ffi_inst_comb_eval = s._ffi_inst.VIntMulScycleV3_noparam_comb_eval
    _ffi_inst_seq_eval  = s._ffi_inst.VIntMulScycleV3_noparam_seq_eval
    ...
    def seq_upblk():
      ...
      if s._ffi_inst.VIntMulScycleV3_noparam_has_assert_fired( _ffi_m ):
        raise AssertionError("A Verilog assertion fired in the Verilator simulation!")

  def assert_on( s, enable ):
    assert isinstance( enable, bool )
    s._ffi_inst.VIntMulScycleV3_noparam_assert_on( s._ffi_m, enable )

  def line_trace( s ):
    if 1:
      s._ffi_inst.VIntMulScycleV3_noparam_line_trace( s._ffi_m, s._ffi_m._cffi_line_trace_str )
